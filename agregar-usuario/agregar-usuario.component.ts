...
export class AgregarUsuarioComponent {
  ...
  paginador_adelante() {
    ...
    mandar_correo(correo_invitado: any) {
      ...
      this.invitacionService.generarInvitacion(token, correo_invitado[0].correo, this.dataService.obtener_usuario(1), this.dataService.obtener_usuario(5), this.dataService.obtener_usuario(2), "usuario")
        .subscribe(
          response => {
